...
void compass_init()
{
    ...
    Serial.printf("00 magBias = %f %f %f ", magBias[0], magBias[1], magBias[2]);
    Serial.printf("00 magScale = %f %f %f ", magScale[0], magScale[1], magScale[2]);
...
void compass_do_periodic_work()
{
     ...
     // Serial print and/or display at 0.5 s rate independent of data rates
        ...
        pitch *= 180.0f / PI;
        yaw   *= 180.0f / PI; 
        yaw   += 11.35f; // Declination at Moscow
        ...
        Serial.print("Mainloop = "); Serial.print((float)sumCount/sum, 2); Serial.println(" Hz");
